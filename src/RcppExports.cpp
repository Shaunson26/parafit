...
RcppExport SEXP _parafit_pf_parafit_cpp(SEXP assoASEXP, SEXP paraBSEXP, SEXP hostCSEXP, SEXP permutationsSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(pf_parafit_cpp(assoA, paraB, hostC, permutations, seed));
...
static const R_CallMethodDef CallEntries[] = {
    {"_parafit_pf_parafit_cpp", (DL_FUNC) &_parafit_pf_parafit_cpp, 5},
