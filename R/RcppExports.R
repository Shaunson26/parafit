...
permute_cube_indices <- function(input_matrix, permutations, seed) {
    .Call(`_parafit_permute_cube_indices`, input_matrix, permutations, seed)
}
...
pf_parafit_cpp <- function(assoA, paraB, hostC, permutations, verbose, print_n, seed) {
    .Call(`_parafit_pf_parafit_cpp`, assoA, paraB, hostC, permutations, verbose, print_n, seed)
}
...
#'
#' @return list of results, with elements global and links (the latter if test_links = TRUE).
pf_parafit_parallel_cpp <- function(assoA, paraB, hostC, permutations, seed, verbose, print_n) {
    .Call(`_parafit_pf_parafit_parallel_cpp`, assoA, paraB, hostC, permutations, seed, verbose, print_n)
}
